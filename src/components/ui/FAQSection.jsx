...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! Try all features for free for the first 14 days. No credit card needed – just dive in and explore! 🌟",
  },
];
...
export function FAQSection() {
  ...
  return (
    <div className="relative w-full h-screen  bg-neutral-950 flex flex-col items-center justify-center antialiased">
      <BackgroundBeams />
